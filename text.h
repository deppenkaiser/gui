...
#define REG_EXP_DEG                 "[0]{0,1}|[0][,]{0,1}|[0][,][0-9]{1,4}|"\
                                    ...
                                    "[1-9]{1,2}|[1-9]{1,2}[,]{0,1}|[1-9]{1,2}[,][0-9]{1,4}|"\
                                    "[1-2]{1,2}|[1-2]{1,2}[0-9]{0,2}[,]{0,1}|[1-2]{1,2}[0-9]{0,2}[,][0-9]{1,4}|"\
                                    "[3]{0,1}|[3][5]{0,1}|[3][5][0-9]{0,1}|[3][5][0-9][,]{0,1}|[3][5][0-9][,][0-9]{1,4}|"\
                                    "[-][1-9]{0,1}|[-][1-9][0-9]{0,1}|[-][1-9][0-9][,]{0,1}|[-][1-9][0-9][,][0-9]{1,4}|"\
                                    "[-][1-2]{1,2}|[-][1-2][0-9]{0,2}|[-][1-2][0-9]{0,2}[,]{0,1}|[-][1-2][0-9]{0,2}[,][0-9]{1,4}|"\
